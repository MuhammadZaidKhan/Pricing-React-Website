        ...
        <div class="flex flex-col min-h-screen bg-white">
            <div class="flex-grow bg-buttonc h-16">
                <div className='flex flex-col justify-center items-center'>
                    <img src={man} alt="man" className='w-70 h-48 mt-24 md:w-50 md:h-32 md:mt-5' />
            ...
            <div class="flex-grow flex justify-center pt-10 md:mb-16 md:pt-2 relative">
                <div className='absolute md:w-64 md:h-72 w-[370px] rounded-xl bg-gray-200 text-black'>
                    <h1 className='font-Poppins font-medium md:text-sm text-lg pt-7 pl-2'>Access these features when you get this pricing package for your business.</h1>

                    <div className='md:text-xs mt-5 pl-5 text-pcolor'>
                        <div className=''>
                    ...
                    <div className='pt-8 flex flex-row'>
                        <div className='flex items-center justify-between pb-2'>
                            {/* icon */}
                            <div>
                                <FontAwesomeIcon icon={faShoppingCart} className='bg-buttonc py-2 px-3 ml-8 h-5 md:ml-4 mt-2' />
                            </div>
                            {/* button */}
                            <div>
                                <button className='bg-buttonc text-white px-20 ml-5 md:px-12 py-2 md:ml-4 font-Poppins font-medium'>Buy Now</button>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div className='flex flex-col md:flex-row md:space-x-5 space-y-3 justify-evenly pt-4 pb-2 md:pl-0 pl-5'>
